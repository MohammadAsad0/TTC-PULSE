...
kpi_c.metric("Highest Composite Score", fmt_float(filtered["composite_score"].max(), digits=3))
...
chart = horizontal_bar_chart(
    ...
    x="composite_score:Q",
    y="station_name:N",
    title="Subway Stations by Composite Reliability Risk Score",
    tooltip=["station_name:N", "rank_position:Q", "composite_score:Q", "frequency:Q"],
)
